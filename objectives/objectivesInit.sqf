...
private ["_location", "_patrolPositions", "_spawnPositions", "_terrain", "_name", "_objective", "_objectiveType"];
...
//debug variables
//player sideChat format ["PATROL: %1 ### SPAWN: %2 ### TERRAIN: %3 ### NAME: %4 ### OBJECTIVE: %5", _patrolPositions, _spawnPositions, _terrain, _name, _objectiveType];

//spawn new mission
[_patrolPositions, _spawnPositions, _terrain, _name] spawn _objective;